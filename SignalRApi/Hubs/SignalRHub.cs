...
namespace SignalRApi.Hubs
{
    public class SignalRHub : Hub //Hub burada sunucu görevi görecek. Bizim dağıtım işlemimiz hub sınıfı hangisi ise onun üzerinden sağlayacağız.
    {
        ...
        public SignalRHub(ICategoryService categoryService, IProductService productService, IOrderService orderService, IMoneyCaseService moneyCaseService, IMenuTableService menuTableService, IBookingService bookingService, INotificationService notificationService, IMenuTableService menutableService)
        {
        ...
        public async Task SendProgress()
        {
            ...
            var value6 = _productService.TProductPriceAvgByHamburger();
            await Clients.All.SendAsync("ReceivePriceAvgByHamburger", value6);
        ...
        public override async Task OnConnectedAsync()//Bu method client'a bağlı olan client sayısını getiriyor.
        {
            clientCount++;
